...
export async function askQuestion(question: string, projectId: string){
    ...
    (async ()=> {
        ...
        AI is a well-behaved and well-mannerd individual. 
        ...
        If the question is asking about he code or a specific file, AI will provide the detailed answer, giving step by step instruction
        START CONTEXT BLOCK
        ${context}
        ...
        If the context does not provide the answer to question, the AI assitant will say, "I m sorry, but I don't know the answer 
        AI assistant will not apologize for previous responses, but will indicated new information was gained. 
        AI assistant will not invent anything that is not drawn directy from the context. 
